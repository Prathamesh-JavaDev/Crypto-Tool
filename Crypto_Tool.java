...
class AppDesk extends JFrame implements ActionListener,ItemListener{
	...
	public AppDesk() {
		...
		File a = new File("C:/Users/Desktop/Crypto-Tool/algo");
	...
	public void itemStateChanged(ItemEvent e){
		...
		switch(clr){
			case "CaesarCypher":{
				FileInputStream cc = new FileInputStream("C:/Users/Desktop/Crypto-Tool/algo/CaesarCypher.txt");
			...
			case "ModifiedCaesarCypher":{
				FileInputStream mcc = new FileInputStream("C:/Users/Desktop/Crypto-Tool/algo/ModifiedCaesarCypher.txt");						desc=new byte[mcc.available()];
				mcc.read(desc);
				//code to create the byte array into a single String.
				String str = new String(desc);
				ta.setText(str);
			...
			case "VigenereCypher":{
				FileInputStream vc = new FileInputStream("C:/Users/Desktop/Crypto-Tool/algo/VigenereCypher.txt");							desc=new byte[vc.available()];
				vc.read(desc);
				//code to create the byte array into a single String.
				String str = new String(desc);
				ta.setText(str);
